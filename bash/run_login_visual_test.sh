...
TEST_FOLDER="../tests/visual/login_visual"

# корневая папка для отчетов
REPORT_ROOT="../reports/login_visual"
...
echo "Доступно по: https://uc4.ru/frontend-autotests-reports/login_visual/${DATE_STR}/${REPORT_FILE}"